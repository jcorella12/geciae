...
export default async function ActivoDetallePage({ params }: { params: { id: string } }) {
  ...
  // ¿Puede editar este activo? CEO, director o contralor de la empresa
  // propietaria. Habilita el enlace a /activos/compartidos/[id]/editar.
  const puedeEditar =
    esCEO(v) ||
      ...
      {puedeEditar && (
        <p className="text-[11px] text-ink-3">
          ...
          <Link
            ...
            href={`/activos/compartidos/${a.id}/editar`}
          >
            Modificar datos
          </Link>
        </p>
